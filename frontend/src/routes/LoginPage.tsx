...
export default function LoginPage() {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError("Unable to connect or sign in. Demo mode is active; connect the API for authenticated access.");
      navigate("/");
    } finally {
      setLoading(false);
    }
