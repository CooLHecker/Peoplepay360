...
export default function EmployeeFormPage() {
  ...
  useEffect(() => {
    ...
    apiClient
      ...
      .catch(() => {
        ...
        if (demo) { setName(demo.fullName); setEmail(`${demo.fullName.toLowerCase().replace(" ", ".")}@peoplepay.test`); }
      })
  ...
  const submit = async (event: FormEvent) => {
    ...
    try {
      const payload: Record<string, unknown> = { full_name: name, work_email: email };
