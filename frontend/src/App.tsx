  ...
  return (
    <Routes>
      ...
      <Route element={<RequireSession><AppLayout /></RequireSession>}>
        ...
        <Route path="/reports/employee-summary" element={<RequireSession admin><EmployeeReportPage /></RequireSession>} />
        ...
        <Route path="/reports" element={<RequireSession admin><ReportsPage /></RequireSession>} />
      </Route>
